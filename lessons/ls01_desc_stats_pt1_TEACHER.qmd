...
```{r}
# Load packages - we use pload form pacman, loads them and installs. tidyverse data manip, here for file paths, janitor tabyls, inspect and vis for data exploration.
pacman::p_load(tidyverse, here, janitor, inspectdf, visdat)
```
...
![](images/structure-of-dataset.png){fig-align="center"}
