...
1.  Understand the key branches of statistics.
2.  Explain the purpose and methods of descriptive statistics.
3.  Identify numerical and categorical variables and their subtypes.
4.  Create appropriate graphical summaries for different variable types using {ggplot2} and {inspectdf} R.
5.  Recognize common data distributions and assess symmetry. 
...
## Statistical Inference: Population and Samples
...
1.  **Graphical methods** (e.g., tables, charts)
    -   **Categorical Distributions**
        ...
        -   **Nominal variables** (no inherent order, e.g., gender, country)

            -   Bar chart or pie cahrt
            -   Box plot (if plotted against a continuous variable)

        -   **Ordinal variables** (clear order, e.g., Likert scale: *poor*, *fair*, *good*)
    ...
    -   **Numerical Distributions**
        ...
        -   **Continuous variables** (those that can take any value, e.g., heights and weights)

            -   Histogram
            -   Density curve
            -   Box plot

        -   **Discrete variables** (integer counts, e.g., number of cases, age)

            -   Bar charts
            -   Histograms with integer bins
