...
::: practice
**Identifying Variable Types and R Data classes** For each of the following variables, identify (1) the variable type (categorical or numerical), (2) its subtype (e.g., nominal, ordinal, discrete, continuous), and (3) the corresponding R data class.
...
ggplot(yaounde) +
  geom_bar(aes(x = age_category_3_ordered, 
               fill = is_smoker),
           position = "fill")
```
